	...
	render(){
		return (
			<div>
				...
				<h2 className="grey-text">Send your authentication tokens to another client. When the recipient client imports this, their Botrock will have full access to your Spotify account ({this.props.me.id}).</h2>
